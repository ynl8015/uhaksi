...
엄수할 출력 규칙 (위반 금지):
- 공백·줄바꿈 합쳐 최대 300자. 절대 넘기지 말 것.
- 짧은 완결 문장 2~4개만 쓸 것. 문장마다 마침표로 끝내고, 매 문장 다음에는 반드시 실제 줄바꿈(엔터) 한 번만 넣어 다음 문장을 새 줄에 이어 쓸 것. 빈 줄은 넣지 말 것.
- (1) (2) 같은 번호·# 제목·---·**굵게**·목록(- )·이모지 금지.
- 각 문장은 한눈에 읽히게 짧게(가능하면 55자 전후). 난이도·문항 비중·출제 느낌·한 줄 팁을 문장에 녹일 것.
